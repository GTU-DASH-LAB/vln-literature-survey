...
\begin{figure*}[!t]
  ...
  \begin{tabular}{@{}p{0.485\textwidth}@{\hspace{4mm}}p{0.485\textwidth}@{}}
    \centering\includegraphics[width=\linewidth]{fig/arch-a-lgx.png} &
    \centering\includegraphics[width=0.94\linewidth]{fig/arch-b-navgpt2.jpg}
    \tabularnewline[1mm]
    ...
    \tabularnewline[2.5mm]
    \centering\includegraphics[width=\linewidth]{fig/arch-c-beliefmap.png} &
    \centering\includegraphics[width=\linewidth]{fig/arch-d-omninav.png}
    \tabularnewline[1mm]
